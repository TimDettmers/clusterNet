...
WikiMaxoutNet_PCIe2::WikiMaxoutNet_PCIe2()
{
	current_device = 1;
	pthread_t t2;
	pthread_create(&t2,NULL,&WikiMaxoutNet_PCIe2::hello_helper,&this[0]);
	/*
	current_device = 1;
	pthread_t t2;
	pthread_create(&t2,NULL,WikiMaxoutNet_PCIe2::hello_helper,this);
	current_device = 1;
	pthread_t t3;
	pthread_create(&t3,NULL,WikiMaxoutNet_PCIe2::hello_helper,this);
	*/
}


void WikiMaxoutNet_PCIe2::init()
{

	cout << current_device << endl;
	cudaSetDevice(current_device);
	cout << "Mydevice: " << current_device << endl;
	gpu = ClusterNet(12354);

	cout << "post cluster init" << endl;
	/*
...
void WikiMaxoutNet_PCIe2::loadNextDataSet()
{

	cout << "lololoading" << endl;
...
void WikiMaxoutNet_PCIe2::allocateNextBatch(bool isCV)
{
	if(!isCV)
	{
...
void WikiMaxoutNet_PCIe2::nesterov()
{
	//nesterov
...
void WikiMaxoutNet_PCIe2::feedforward()
{
...
void WikiMaxoutNet_PCIe2::weightUpdates()
{
...
void WikiMaxoutNet_PCIe2::backprop()
{
...
double WikiMaxoutNet_PCIe2::calculateError()
{
